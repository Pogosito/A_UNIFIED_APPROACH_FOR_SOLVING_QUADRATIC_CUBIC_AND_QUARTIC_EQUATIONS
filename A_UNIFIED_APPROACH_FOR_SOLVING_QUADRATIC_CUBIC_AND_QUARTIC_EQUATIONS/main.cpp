...
/*
	...
	Описание опечаток стати можно найти на: https://github.com/Pogosito/A_UNIFIED_APPROACH_FOR_SOLVING_QUADRATIC_CUBIC_AND_QUARTIC_EQUATIONS/blob/main/TYPOS_IN_A_UNIFIED_APPROACH_FOR_SOLVING_QUADRATIC_CUBIC_AND_QUARTIC_EQUATIONS.pdf
 */
